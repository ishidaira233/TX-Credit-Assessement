...
if __name__ == '__main__':
    ...
    print('bad precision',precisionArray[0],'good precision',precisionArray[1],\
          'type1', precisionArray[2], 'type2', precisionArray[3], 'total accuracy', precisionArray[4],'AUC',precisionArray[5])
