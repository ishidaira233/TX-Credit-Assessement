...
def svmBagging(SamplingMethode):
    ...
    # 这里的[400,100]表示有两层RBM，每一层输出为400和100
    dbn = DBN([400, 200, 100], opts, trX)
    # DBN训练
    dbn.train()
    ...
    nn = NN([400, 200, 100], opts, trX, trY)
    # 这里加载已经训练好的dbn参数
...
def fsvmBagging(SamplingMethode):
    ...
    clf_svm = [fsvmClass.HYP_SVM(kernel='polynomial', C=1.75, P=0.1) for _ in range(20)]
...
if __name__ == '__main__':
    #可选择lowSamoling，upSamoling和origine
    #svmBagging('lowSampling')
    fsvmBagging('lowSampling')